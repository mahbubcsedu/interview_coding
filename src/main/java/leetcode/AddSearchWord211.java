 ...
 */
  ...
  */
  ...
  public class TrieNode {
	  ...
	  public String item=""; // if it string, this is empty string and means no words end in this node, otherwise we will get the whole word
  }
  ...
  public boolean searchHelper(char[] word, int startPosition, TrieNode startNode) {
	   ...
	   */
	  if(startPosition==word.length) return startNode.item.equals("");
	  /**
