 ...
 * has n commodities like goat, grain, gold, silver etc
...
public class Arbitrage {
	 ...
	 * 
	 * if -log(x) <0 if x is greater than zero. So, if we have negative weight cycle
	 * the product of weighted edge is bigger than 1
	 * @param G
	 * @return
	 */
