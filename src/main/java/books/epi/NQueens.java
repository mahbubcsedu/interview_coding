...
public class NQueens {
	...
	public static void nQueenHelper(int n, int row,List<Integer> temp, List<List<Integer>> res) {
		//we will try to put queens at each row and with all options of column, if the number of queen and rows are same, we can add the result
